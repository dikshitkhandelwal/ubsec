...
JonathanPestinger.propTypes = {
    
};

function JonathanPestinger(props) {

    return (
        <div>

            <PageTitle sub='Eboard' title='Dikshit Khandelwal' />
                        ...
                        <div className="col-md-12">
                            <div className="tf-item-detail-inner">
                                ...
                                <div className="content">
                                    <h2 className="title-detail">Jonathan Pestinger</h2>
...
export default JonathanPestinger;